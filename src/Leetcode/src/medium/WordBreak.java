...
public class WordBreak {
	...
	public static void main(String[] args) {
		...
		List<String> list4 = new ArrayList<>(Arrays.asList("cats","dog","sand","and","cat"));
		String s1 = "leetcode";
...
//        System.out.println(Break(s, list));
		System.out.println(wordBreak1(s4, list4));
//		System.out.println(breakDP(s2, list2));
	}
	...
	// have to use DP
	// TC: n2
	static boolean breakDP(String s, List<String> words) {
